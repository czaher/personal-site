...
export const DEFAULT_TRAINING_EDGES: EdgeDef[] = [
  ...
  { id: 'te6', source: 'yolov8s', target: 'trainer', targetHandle: 'top-in', type: 'smoothstep', style: eS, markerEnd: arr },
  { id: 'te7', source: 'train-data-1', target: 'trainer', targetHandle: 'top-in', type: 'smoothstep', style: eS, markerEnd: arr },
  ...
  { id: 'te9', source: 'model-top', sourceHandle: 'right', target: 'model-bottom', targetHandle: 'right-in', type: 'dropRight', style: eS, markerEnd: arr },
  ...
  { id: 'te13', source: 'train-data-2', sourceHandle: 'bottom', target: 'trainer', targetHandle: 'top-in', type: 'leftSide', style: eS, markerEnd: arr },
